...
import { ChartDataPoint } from '@/components/app/deficit-progress-chart';
import dynamic from 'next/dynamic';

const DeficitProgressChart = dynamic(() => import('@/components/app/deficit-progress-chart').then(mod => mod.DeficitProgressChart), { loading: () => <Loading /> });
const WeightTrendChart = dynamic(() => import('@/components/app/weight-trend-chart').then(mod => mod.WeightTrendChart), { loading: () => <Loading /> });
