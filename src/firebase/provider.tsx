    ...
    const unsubscribeAuth = onAuthStateChanged(
      ...
      (firebaseUser) => {
        if (firebaseUser) {
          ...
          setDocumentNonBlocking(userDocRef, { name: firebaseUser.displayName, email: firebaseUser.email, id: firebaseUser.uid }, { merge: true });
  ...
  useEffect(() => {
    if (userAuthState.user) {
      ...
      const unsubscribeProfile = onSnapshot(profileRef, (docSnap) => {
        ...
        // This is the fix: only stop loading when we have confirmed data from the server
